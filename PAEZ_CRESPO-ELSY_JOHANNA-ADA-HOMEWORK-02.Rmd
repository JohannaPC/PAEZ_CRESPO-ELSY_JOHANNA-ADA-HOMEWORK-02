...
<span style="color:green">***SE's of the mean and SD's of the sample were similar. However, The standard error of the mean is an estimate of how far a given sample mean is likely to be from the population mean. The standard deviation of a sample is a measure of the degree to which individual values within a sample differ from the mean for that sample. SE's of weight and zombies killed from 2.e were slightly higher than the SD's of weight and zombies of the sampling distribution***</span>
...
<span style="color:green">***Mean Height is normally distributed***</span>
